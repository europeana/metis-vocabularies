...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#" xmlns:skos="http://www.w3.org/2004/02/skos/core#" version="1.0" xmlns:skosxl="http://www.w3.org/2008/05/skos-xl#" xmlns:ekt="https://www.semantics.gr/authorities/schemanamespaces/ekt#">
    ...
    <xsl:for-each select="./*">
      <xsl:if test="@rdf:about=$targetId">
        <skos:Concept>
          ...
          <!-- Tag mapping: ekt:distinctPrefLabel -> skos:prefLabel -->
          <xsl:apply-templates select="ekt:distinctPrefLabel" />
  ...
  <!-- Template for ekt:distinctPrefLabel -->
  <xsl:template match="ekt:distinctPrefLabel">
