...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="/rdf:RDF"><!-- Parent mapping: rdf:Description -> edm:Agent -->
        <xsl:for-each select="./rdf:Description[@rdf:about=$targetId]">
            ...
            <xsl:if test="rdf:type/@rdf:resource[.='http://d-nb.info/standards/elementset/gnd#SeriesOfConferenceOrEvent']">
                <edm:Agent><!-- Attribute mapping: rdf:about -> rdf:about -->
                    ...
                    </xsl:for-each><!-- Tag mapping: gndo:variantNameForTheConferenceOrEvent -> skos:altLabel -->
                    ...
                    </xsl:for-each><!-- Tag mapping: gndo:preferredNameForTheConferenceOrEvent -> skos:prefLabel -->
